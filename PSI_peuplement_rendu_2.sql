...
VALUES ('301', 10, 'Pizza végétarienne', 0, 'user_alice'),
...
VALUES('401', 500.50, 0, 'user_antoine'),
...
-- Maintenant on va créer des plats, des commandes, des livraisons et des commentaires
-- Insertion de 15 plats avec des cuisiniers existants
INSERT INTO Plat (ID_Plat, Nom_plat, Type_Plat, Pr_cmb_de_personnes_Plat, Prix_par_perso_Plat, date_fabrication_plat, date_péremption_plat, Nationalité_cuisine_Plat, Régime_alimentaire_Plat, Ingrédients_principaux_Plat, ID_Cuisinier) 
VALUES 
(501, 'Pizza végétarienne', 'Plat', 2, 12.50, '2025-03-30', '2025-04-02', 'Italienne', 'Végétarien', 'Farine, Tomate, Fromage', 301),
(502, 'Sushi', 'Plat', 1, 15.00, '2025-03-30', '2025-04-01', 'Japonaise', 'Poisson cru', 'Riz, Saumon, Algues', 302),
(503, 'Tacos', 'Plat', 1, 8.50, '2025-03-30', '2025-04-03', 'Mexicaine', 'Viande', 'Tortilla, Bœuf, Fromage', 304),
(504, 'Pâtes Carbonara', 'Plat', 2, 10.00, '2025-03-30', '2025-04-04', 'Italienne', 'Omnivore', 'Pâtes, Crème, Lardons', 305),
(505, 'Salade César', 'Entrée', 1, 9.00, '2025-03-30', '2025-04-02', 'Américaine', 'Végétarien', 'Salade, Poulet, Parmesan', 304),
(506, 'Ratatouille', 'Plat', 2, 11.00, '2025-03-30', '2025-04-05', 'Française', 'Végétarien', 'Aubergine, Courgette, Tomate', 301),
(507, 'Couscous', 'Plat', 4, 20.00, '2025-03-30', '2025-04-07', 'Marocaine', 'Halal', 'Semoule, Viande, Légumes', 304),
(508, 'Burger', 'Plat', 1, 14.50, '2025-03-30', '2025-04-03', 'Américaine', 'Omnivore', 'Pain, Steak, Fromage', 304),
(509, 'Paella', 'Plat', 3, 18.00, '2025-03-30', '2025-04-06', 'Espagnole', 'Poisson', 'Riz, Fruits de mer, Safran', 303),
(510, 'Soupe Pho', 'Plat', 2, 13.00, '2025-03-30', '2025-04-04', 'Vietnamienne', 'Sans gluten', 'Nouilles de riz, Bouillon, Bœuf', 304),
(511, 'Samosa', 'Entrée', 1, 5.00, '2025-03-30', '2025-04-02', 'Indienne', 'Végétarien', 'Pâte, Légumes, Épices', 304),
(512, 'Poutine', 'Plat', 2, 10.00, '2025-03-30', '2025-04-05', 'Canadienne', 'Omnivore', 'Frites, Fromage, Sauce brune', 303),
(513, 'Bruschetta', 'Entrée', 1, 6.50, '2025-03-30', '2025-04-02', 'Italienne', 'Végétarien', 'Pain, Tomate, Basilic', 305),
(514, 'Gyoza', 'Entrée', 1, 8.00, '2025-03-30', '2025-04-03', 'Japonaise', 'Viande', 'Pâte, Porc, Gingembre', 302),
(515, 'Pizza Margherita', 'Plat', 2, 12.50, '2025-03-30', '2025-04-03', 'Italienne', 'Viande', 'Farine, Tomate, Fromage, Jambon', 305);
