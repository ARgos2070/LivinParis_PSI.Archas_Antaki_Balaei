...
namespace PSI_application_C__web
{
    public class Client : Utilisateur
    {
        ...
        public Client(string mot_de_passe_utilisateur, string nom_utilisateur, string prenom_utilisateur, string adresse_utilisateur, string num_utilisateur, string adresse_mail_utilisateur, bool utilisateur_est_entreprise, string nom_entreprise_utilisateur) : 
        ...
        public Client(Utilisateur user, int id_client, int Nbre_commandes_passees_client)
