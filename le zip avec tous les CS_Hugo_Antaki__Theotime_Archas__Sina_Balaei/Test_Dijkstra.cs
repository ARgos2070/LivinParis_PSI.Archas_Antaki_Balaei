namespace PSI_application_C__web
{
    public class Test_Dijkstra
    {
        ...
        [TestCase(2)]
        [TestCase(3)]
        public void Test_Dijkstras_non_metro(int selector)
        {
            ...
            List<string> parcourt = test_Graphe.Dijikstra("A", "D");
        ...
        [TestCase(1)]
        [TestCase(2)]
        public void Test_Dijkstras_metro(int selector)
        {
            Graphe lesmetros = new Graphe();
            List<string> parcourt = new List<string>();
            switch (selector)
            {
                case 1: parcourt = lesmetros.Dijikstra("Ternes2", "Argentine1");  
                    break;
                case 2: parcourt = lesmetros.Dijikstra("Mairie des Lilas11", "Rue de la Pompe9"); 
                    break;
                default: break;
            }
            string answer = Stringify(parcourt);
